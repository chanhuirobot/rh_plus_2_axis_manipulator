...
int main(int argc, char* argv[])
{
  ...
  // plan 좌표 입력
  // 사각형 좌측 하단 이동
  target_pose.position.x = 0.49 * BOARD_WIDTH;
  target_pose.position.y = 0.02 * BOARD_HEIGHT;
  ...
  target_pose.position.x = 0.56 * BOARD_WIDTH;
  target_pose.position.y = 0.25 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);


  target_pose.position.x = 0.80 * BOARD_WIDTH;
  target_pose.position.y = 0.25 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);


  target_pose.position.x = 0.74 * BOARD_WIDTH;
  target_pose.position.y = 0.25 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);


  target_pose.position.x = 0.74 * BOARD_WIDTH;
  target_pose.position.y = 0.31 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);


  target_pose.position.x = 0.74 * BOARD_WIDTH;
  target_pose.position.y = 0.18 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);
  ...
  target_pose.position.x = 0.56 * BOARD_WIDTH;
  target_pose.position.y = 0.24 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);


  target_pose.position.x = 0.62 * BOARD_WIDTH;
  target_pose.position.y = 0.45 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);
  ...
  target_pose.position.y = -0.20 * BOARD_HEIGHT;
  waypoints.push_back(target_pose);
