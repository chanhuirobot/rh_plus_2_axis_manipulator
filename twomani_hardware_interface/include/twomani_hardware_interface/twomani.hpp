...
#include "twomani_hardware_interface/twomani_drvr.hpp"
...
namespace twomani
{
	class twomani
	{
		...
		private:
			...
			std::unique_ptr<twomani_drvr> drvr_;
			...
			// Map of joint to the last position set on the joint (in twomani units)
			PositionMap last_pos_set_map_;
			// Map of joint to the last position status read for the joint (in twomani units)
